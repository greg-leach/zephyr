...
The BT6x0 incorporates three mechanical push buttons. Note these are only accessible with the housing cover removed.
...
To provide a high level on the external digital output, a high logic level is applied to the appropriate
